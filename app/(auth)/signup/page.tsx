      ...
      <div className="hidden lg:flex w-[55%] relative overflow-hidden flex-col justify-between p-12 bg-gradient-to-br from-primary-900 via-[#0f0f13] to-secondary-900">
        ...
        <div className="relative z-10 max-w-lg">
          <h1 className="text-5xl font-bold text-white mb-6 leading-tight">
            Start your journey to <span className="text-gradient bg-gradient-to-r from-primary-400 to-secondary-400 bg-clip-text text-transparent">excellence</span>
          </h1>
          <p className="text-content-secondary text-lg leading-relaxed">
            Join thousands of learners building real-world skills and leveling up their careers with world-class courses.
          </p>
        ...
        <div className="relative z-10">
          <div className="flex items-start gap-4 bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
            ...
            <div>
              <p className="text-white/80 text-sm italic mb-2">"The best investment I've ever made. Landed my dream job within 3 months of completing the program."</p>
              <p className="text-primary-400 text-xs font-semibold">Sarah Kim • Product Designer at Meta</p>
            </div>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-body text-content-secondary">
              Get started in seconds and unlock your potential
            </p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-surface text-content-tertiary font-medium">Or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="input-helper">Must be at least 8 characters</p>
            </div>
            ...
            <div className="flex items-start gap-3">
              <input 
                type="checkbox" 
                id="terms"
                className="w-4 h-4 mt-0.5 rounded border-border text-primary-600 focus:ring-primary-500 focus:ring-2"
                required
              />
              <label htmlFor="terms" className="text-small text-content-secondary leading-relaxed">
                I agree to the <Link href="/terms" className="text-primary-600 hover:underline font-medium">Terms of Service</Link> and <Link href="/privacy" className="text-primary-600 hover:underline font-medium">Privacy Policy</Link>
              </label>
            </div>
